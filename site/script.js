/**
 * Created by Max-Starling on 05.03.2017.
 */
var news = [
    /*var new1 = */{
        ID: '0001',
        ...
        createdAt: new Date('2017-03-05T00:00:00'),
    ...
    /*var new2 = */{
        ...
        createdAt: new Date("2017-03-05T01:01:01"),
        author: 'Lewis Carroll',
    ...
    /*var new3 = */{
        ...
        createdAt: new Date("2017-03-05T02:02:02"),
        author: 'Lewis Carroll',
    ...
    /*var new4 = */{
        ...
        createdAt: new Date("2017-03-05T03:03:03"),
        author: 'Lewis Carroll',
    ...
    /*var new5 = */{
        ...
        createdAt: new Date("2017-03-05T05:05:05"),
        author: 'Lewis Carroll',
    ...
    /*var new6 = */{
        ...
        createdAt: new Date("2017-03-05T06:06:06"),
        author: 'Lewis Carroll',
        content: 'The Caterpillar and Alice looked at each other for some time in silence: at last the Caterpillar took the ' +
    ...
    /*var new7 = */{
        ...
        createdAt: new Date("2017-03-05T07:07:07"),
        author: 'Lewis Carroll',
    ...
    /*var new8 = */{
        ...
        createdAt: new Date("2017-03-05T08:08:08"),
        author: 'Lewis Carroll',
    ...
    /*var new9 = */{
        ...
        createdAt: new Date("2017-03-05T09:09:09"),
        author: 'Lewis Carroll',
    ...
    /*var new10 = */{
        ...
        createdAt: new Date("2017-03-05T10:10:10"),
        author: 'Lewis Carroll',
    ...
    /*var new11 = */{
        ...
        createdAt: new Date("2017-03-05T11:11:11"),
        author: 'Lewis Carroll',
    ...
    /*var new12 = */{
        ...
        createdAt: new Date("2017-03-05T12:12:12"),
        author: 'Lewis Carroll',
    ...
    /*var new13 = */{
        ...
        title: 'I',
        summary: 'Once',
        createdAt: new Date("2017-03-05T13:13:13"),
    ...
    /*var new14 = */{
        ...
        title: 'II',
        summary: 'So',
        createdAt: new Date("2017-03-05T14:14:14"),
        author: 'Antoine de Saint-Exupery',
    ...
    /*var new16 = */{
        ...
        title: 'IV',
        summary: 'I',
        createdAt: new Date("2017-03-05T16:16:16"),
        author: 'Antoine de Saint-Exupery',
    ...
    /*var new17 = */{
        ...
        title: 'V',
        summary: 'As',
        createdAt: new Date("2017-03-05T17:17:17"),
        author: 'Antoine de Saint-Exupery',
    ...
    /*var new18 = */{
        ...
        title: 'VI',
        summary: 'Oh',
        createdAt: new Date("2017-03-05T18:18:18"),
        author: 'Antoine de Saint-Exupery',
    ...
    /*var new19 = */{
        ...
        title: 'VII',
        summary: 'On',
        createdAt: new Date("2017-03-05T19:19:19"),
        author: 'Antoine de Saint-Exupery',
    ...
    /*var new20 = */{
        ...
        title: 'VIII',
        summary: 'I',
        createdAt: new Date("2017-03-05T20:20:20"),
        author: 'Antoine de Saint-Exupery',
...
function validateNew(n) {
    /*ID*/
    if (!n.ID) {
        console.log("Oops. Something is wrong with author. You should try again later.");
        return false;
    }
    /*Title*/
    if (!n.title){
        ...
        if ((n.title.length >= 100) || n.title.length == 0){
            console.log("Oops. Something is wrong with title length. You should check it and try again.");
            return false;
        }
    }
    /*Summary*/
    if(!n.summary){
        return false;
            ...
            console.log("Oops. Something is wrong with summary length. You should check it and try again.");
            return false;
    }
    /*Date*/
    if (!n.createdAt)
    {
        console.log("Oops. Something is wrong with date. You should try again later.");
        return false;
    }
    /*Author*/
    if(!n.author) {
        ...
        console.log("Oops. Something is wrong with author name length. You should check it and try again.");
        return false;
    }
    /*Content*/
    if(!n.content){
