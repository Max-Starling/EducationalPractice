...
2. Поик по дате в таком формате: 
  * Feb 05 2017
  * Ни одно из этих полей не является обязательным, но вводить именно в таком порядке(пока что).
  * Регистр не имеет значения.
  * Пример: Если написать просто число 17, то может вывести всё, в чём присутствует цифра 17. Даты или с тамким годом, или днём, или часами, или ещё с чем-либо другим.
