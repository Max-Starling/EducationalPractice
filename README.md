...
=======================================
1. Добавлено модальное окно "Contact us". Теперь все элементы меню правой панели кликабельны.
  * В этом окне мы можете оставить свой отзыв, жалобу или же предложить мне свежую идею.
