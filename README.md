...
Насчёт базы данных: в папке private лежит ещё две папки:
в одной 3 файла для mongoshell, в другой - для mongoexport. Что Яне и Владу (а, возможно, и кому-то ещё) удобнее, то пусть и используют. 
