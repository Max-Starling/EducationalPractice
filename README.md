...
=======================================
1. Добавлены функции logIn и logOut, соответствующие заданию 11, причём функция LogIn заменила уже функцию checkUser, написанную ранее и не использующую passport и promises.
